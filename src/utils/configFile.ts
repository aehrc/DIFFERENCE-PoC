...
export interface ConfigFile extends OAuthConfig {
  // Optional secondary fhir server
  secondaryFhirServer?: OAuthConfig;

  // Optional branding configuration
  branding?: {
    // Store assets in /public and provide relative paths
    logoUrl?: string | null;
    bannerUrl?: string | null;
    // Store in /src/styles and provide relative paths
